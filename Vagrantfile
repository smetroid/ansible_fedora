...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "personal" do |desktop|
    ...
    desktop.vm.provider :libvirt do |v|
      ...
      v.customize ["modifyvm", :id, "--mouse", "usb"]
			...
			#v.customize ["storageattach", :id, "--storagectl", "IDE Controller", "--tport 0", "--device 0", "--type", "dvddrive"]
    end
  end

  #config.vm.define "rails" do |web|
  #  web.vm.box = "centos/7"
  #  web.vm.id = 1
  #  web.vm.cpus = 2
  #  web.vm.memory = 3072
  ...
  #  web.vm.box = "centos/7", id:1 cpus: 2, memory: 3072
  #end
